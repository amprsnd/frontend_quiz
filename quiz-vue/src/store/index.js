export default{
  ...
  css: [
    ...
    {
      code: '',
      question: 'Does setting <code>margin-top</code> and <code>margin-bottom</code> have an affect on an inline element?',
      answers: [
        {
          answer: 'Yes',
          correct: false
    ...
    {
      code: '',
      question: 'Does setting <code>padding-top</code> and <code>padding-bottom</code> on an inline element add to its dimensions?',
      answers: [
        {
          answer: 'Yes',
          correct: false
    ...
    {
      code: '',
      question: 'If you have a <code>&lt;p&gt;</code> element with <code>font-size: 10rem</code>, will the text be responsive when the user resizes / drags the browser window?',
      answers: [
        {
          answer: 'Yes',
          correct: false
  ...
  html: [
    {
      code: '',
      question: 'Is <code>&lt;keygen&gt;</code> a valid HTML5 tag?',
      answers: [
        {
          answer: 'Yes',
          correct: true
    ...
    {
      code: '',
      question: 'Does the <code>&lt;bdo&gt;</code> tag change the direction of text?',
      answers: [
        {
          answer: 'Yes',
          correct: true
    ...
    {
      code: '',
      question: 'In what situation should you use the <code>&lt;small&gt;</code> tag?',
      answers: [
        {
    ...
    {
      code: '',
      question: 'If a web page contains organic, multiple <code>&lt;h1&gt;</code> tags, will it affect the SEO negativley?',
      answers: [
        {
          answer: 'Yes',
          correct: false
